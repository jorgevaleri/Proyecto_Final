...
<body class="body">
    ...
    <main class="cuerpo">
        ...
        <ul class="botones">
            <li class="boton-aceptar"><a href="director-modificar.html"> Modificar</a></li>
            <li class="boton-aceptar"><a href="director-cambiar-contraseña.html"> Cambiar contraseña</a></li>
        </ul>
    </main>
</body>
