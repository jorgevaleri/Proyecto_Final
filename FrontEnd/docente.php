...
<body class="body">
    ...
    <main class="cuerpo">
                ...
                <form action="#">
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input type="text" value="34.129.892">
                        </div>
                        <div class="input-box">
        ...
        <ul class="botones">
            <li class="boton-aceptar"><a href="docente-modificar.html"> Modificar</a></li>
            <li class="boton-aceptar"><a href="cambiar-contraseña.html"> Cambiar contraseña</a></li>
        </ul>
    </main>
</body>
