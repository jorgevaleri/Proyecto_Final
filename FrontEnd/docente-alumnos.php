...
<body class="body">
    ...
    <main class="cuerpo">
        <div class="menu-interno">
            <ul>
                <li><a href="docente-registro.html">Registro</a></li>
                <li><a href="docente-resumen.html">Resumen</a></li>
                <li class="seleccion2"><a href="docente-alumnos.html">Alumno</a></li>
            </ul>
        </div>
            ...
            <table class="tabla1">
                ...
                <tr class="tablatd-datos">
                    ...
                    <div class="botones-tabla">
                        <td>
                            <a href="ver-alumno.html" class="bi bi-eye-fill"></a>
                            <a href="editar-alumno.html" class="bi bi-pencil-fill"></a>
        ...
        <div>
            <div class="boton-agregar">
                <a href="agregar-alumno.html"> Agregar Alumno</a>
            </div>
        </div>
    </main>
</body>
