 ...
 <aside class="cuerpo-menu-vertical">
    ...
    <main class="cuerpo">
        <div>
            ...
            <div class="title">Editar Escuela</div>
	...
	if(isset($_GET['id']))
	{
		...
		if(isset($_POST['modificar']))
		{
			...
			if($c==0){
				$sql="UPDATE escuelas SET escuelas_nombre='$escuelas_nombre', escuelas_cue='$escuelas_cue' WHERE escuelas_id='$id'";
				...
				if (mysqli_errno($conexion)==0){
					...
					?>
					<script >	
						alert('Verifique. No se actualizo la Escuela');
						location.href ='escuela.php';
					</script>	
					<?php
				}
		...
		if(!isset($_POST['modificar']) or $c!=0)
		{
			...
			<form action="escuela_editar.php?tipo=<?php echo $tipo;?>&id=<?php echo $id; ?>" method="post" name="form1" id="form1">

			<table width="758" border="1" align="center">
				<tr>	
					<td height="42">	
						<p>Id: 
							<input name="escuelas_id" type="text" id="escuelas_id" value="<?php echo $_POST['escuelas_id']; ?>" size="30" maxlength="60" readonly>
							<?php
							?>
						</p>
					</td>
