            ...
            <ul class="menu-vertical">
                <li><a href="#">Escuelas</a>
                    <ul class="submenu-vertical">
                        <li class="sin-seleccion"><a href="docente-registro.html">EDJA N° 38</a></li>
                        <li class="sin-seleccion"><a href="#">Escuela 2</a></li>
                        <li class="sin-seleccion"><a href="#">Escuela 3</a></li>
                        <li class="seleccion"><a href="agregar-escuela.html">Agregar Escuela</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <form action="#">
                    ...
                    <div>
                        <div class="boton-agregar">
                            <a href="docente-registro.html">Agregar Escuela</a>
                        </div>
                    </div>
                </form>
            </div>
