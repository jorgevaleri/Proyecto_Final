...
<body class="body">
            ...
            <ul class="menu-vertical">
                <li><a href="#">Escuelas</a>
                    <ul class="submenu-vertical">
                        <li class="seleccion"><a href="director-escuela.html">EDJA N° 38</a></li>
    ...
    <main class="cuerpo">
        <div class="container">
            <div class="title">Modificar Escuela</div>
            <div class="content">
                <form action="#">
                    <div class="user-details">
                        <div class="input-box">
                            <span class="details">Escuela</span>
                            <input type="text" value="EDJA N° 38">
                        </div>
                        <div class="input-box">
                            <span class="details">CUE</span>
                            <input type="text" value="100082-00">
                        </div>
                        <div class="input-box">
                            <span class="details">Direccion</span>
                            <input type="text" value="Florida y Junin">
                        </div>
                    </div>
                </form>
            </div>
        ...
        <ul class="botones">
            <li class="boton-cancelar"><a href="director-escuela.html"> Cancelar</a></li>
            <li class="boton-aceptar"><a href="director-escuela.html"> Guardar Cambios</a></li>
        </ul>
    </main>
</body>
