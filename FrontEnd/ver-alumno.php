...
<head>
    ...
    <link rel="stylesheet" href="CSS/agregar-alumno.css">
...
<body class="body">
    <header>
        <div class="ancho">
            ...
            <nav>
                <ul>
                    <li><a href="inicio_sesion.html">Docente</a></li>
    ...
    <main class="cuerpo">
                ...
                <form action="#">
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input type="text" value="36844411">
                        </div>
                        <div class="input-box">
                            <span class="details">Apellidos</span>
                            <input type="text" value="Aranda">
                        </div>
                        <div class="input-box">
                            <span class="details">Nombres</span>
                            <input type="text" value="Georgina Elizabeth">
                        </div>
                        <div class="input-box">
                            <span class="details">Fecha de Nacimiento</span>
                            <input type="date" value="1992-01-18">
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" value="3834651363">
                        </div>
                        <div class="input-box">
                            <span class="details">Direccion</span>
                            <input type="text" value="Casa S/N - Las Tejas - Valle Viejo">
                        </div>
                        <div class="input-box">
                            <span class="details">Localidad</span>
                            <input type="text" value="Valle Viejo">
                        </div>
                        <div class="input-box">
        ...
        <div>
            <div class="boton-agregar">
                <a href="docente-alumnos.html"> Volver</a>
            </div>
        </div> 
    </main>
</body>
